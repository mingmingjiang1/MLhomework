...
zeros = np.zeros((20,))
total_arr_1 = []
path1 = r"C:\Users\Mmjiang\Desktop\ML_homework\Layer1-positive.txt"
with open(path1) as obj:
    for i in obj.readlines():
        if re.match('>',i)==None:
            #num += 1
            i = list(i)
            for z in range(101-len(i)):
                i.append(0)
            arr = []
            for acid in Acid:
                acid_list = []
...
total_arr_0 = []
path2 = r"C:\Users\Mmjiang\Desktop\ML_homework\Layer1-negative.txt"
...
path3 = r"C:\Users\Mmjiang\Desktop\ML_homework\Layer1-Ind-negative.txt"
...
total_arr_1_ind = []
path4 = r"C:\Users\Mmjiang\Desktop\ML_homework\Layer1-Ind-positive.txt"
...
class ConvNet(torch.nn.Module):
    def __init__(self):
        ...
        self.fc.add_module("fc1",torch.nn.Linear(24*128,128))
